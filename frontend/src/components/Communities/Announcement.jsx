...
const Announcement = ({ imgSrc, Name, ID, UserImage, description, title }) => {
    const CommentData = [
        {
            UserName: "Sam",
            Comments: "Starboy",
    ...
    return (
        <div className="  bg-gradient-to-br from-[#242380] via-blue-950 to-purple-800  w-full h-[600px] rounded-lg p-2 my-5">
            ...
            <div className="flex w-full h-4/5 ">
                <div
                    className={`${CommentToggle ? "" : "hidden"} w-11/12 h-fit rounded-lg bg-[#1a072cbf] bg-opacity-90  absolute`}
                >
                    ...
                    <div className="flex flex-col justify-center items-center m-3">
                        ...
                        <div className="w-2/3 h-fit m-2 flex">
                            <button
                                className="w-1/2 h-full rounded-lg p-2  font-bold mx-1
                                                    bg-[#9b9b9b98] hover:bg-[#641e80] hover:text-gray-200 text-gray-300 duration-700"
                            >
                                Comment
                            </button>
                            <button
                                className="w-1/2 h-full bg-[#9b9b9b98] rounded-lg p-2 text-gray-300 duration-700 font-bold mx-1
                                                    hover:bg-red-600"
            ...
            <div>
                <div className=" h-full w-full flex justify-around mx-2 my-3">
                    <div className="flex w-full  text-white font-semibold text-xl h-full">
                        Caption
                    </div>
                </div>
            </div>
